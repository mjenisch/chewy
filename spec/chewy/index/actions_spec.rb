...
describe Chewy::Index::Actions do
  ...
  describe '.create!' do
    ...
    context do
      ...
      specify do
        expect do
          DummiesIndex.create!
        end.to raise_error(OpenSearch::Transport::Transport::Errors::BadRequest).with_message(/already exists.*dummies/)
      end
      specify do
        expect do
          DummiesIndex.create!('2013')
        end.to raise_error(OpenSearch::Transport::Transport::Errors::BadRequest).with_message(/Invalid alias name \[dummies\]/)
      end
    end
    ...
    context do
      ...
      specify do
        expect do
          DummiesIndex.create!('2013')
        end.to raise_error(OpenSearch::Transport::Transport::Errors::BadRequest).with_message(/already exists.*dummies_2013/)
      end
      specify { expect(DummiesIndex.create!('2014')['acknowledged']).to eq(true) }
  ...
  describe '.delete!' do
    specify { expect { DummiesIndex.delete! }.to raise_error(OpenSearch::Transport::Transport::Errors::NotFound) }
    specify do
      expect do
        DummiesIndex.delete!('2013')
      end.to raise_error(OpenSearch::Transport::Transport::Errors::NotFound)
    end
